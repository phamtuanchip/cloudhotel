...
public class RunMeTask {
	...
	@Autowired
	private HotelServiceFactory hotelServiceF;
	...
	public  HotelService InstanceHService(){
		return hotelServiceF.getService();
	}
	...
	public HotelServiceFactory getHotelServiceF() {
		return hotelServiceF;
	}
	public void setHotelServiceF(HotelServiceFactory hotelServiceF) {
		this.hotelServiceF = hotelServiceF;
	}
}